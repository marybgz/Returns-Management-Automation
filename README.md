...
Process Flow
Request is created through Power Apps
Data is stored in a SharePoint list
The request is assigned and analyzed
Approval is handled through automated flows
Logistics updates the status directly in the system
